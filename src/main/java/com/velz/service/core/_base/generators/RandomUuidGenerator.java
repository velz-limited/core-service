package com.velz.service.core._base.generators;
...
public class RandomUuidGenerator implements BeforeExecutionGenerator {
    ...
    public RandomUuidGenerator(com.velz.service.core._base.generators.annotations.RandomUuidGenerator config, Member idMember, CustomIdGeneratorCreationContext creationContext) {
        this(idMember);
    }
